...
- **Phase**: [CONSTRUCTION / INCEPTION / PRE-FLIGHT / OPERATIONS]
- **Skill at pause**: [skill-name] (Step N — reason for pause)
- **Next skill to invoke**: `/aicodepath-<skill>`
- **Exact invocation**: `/aicodepath-tdd` — Batch 1, Task 1: [task title]
- **Plan file**: `aicodepath-docs/plan/YYYY-MM-DD-<topic>-plan.md` (or `aicodepath-docs/plan/` for pre-ADR-006 plans)
- **Tasks file**: `aicodepath-docs/task/YYYY-MM-DD-<topic>-tasks.md` — Batch=1, Status=TODO
- **Batch progress**: Batch 0/N complete
