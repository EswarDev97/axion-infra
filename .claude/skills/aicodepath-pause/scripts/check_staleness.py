...
Usage:
    ...
    python check_staleness.py aicodepath-docs/handoffs/2024-01-15-143022-auth.md
"""
...
def check_staleness(handoff_path: str) -> dict:
    ...
    if not project_path or not Path(project_path).exists():
        # Fallback: assume handoff is in aicodepath-docs/handoffs/ within project
        project_path = get_project_root(hint=path)
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python3 check_staleness.py aicodepath-docs/handoffs/2024-01-15-auth.md")
        sys.exit(1)
