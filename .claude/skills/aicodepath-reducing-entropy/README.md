...
- Working in **MAINTENANCE phase** of AICodePath lifecycle
- Refactoring **brownfield codebases** that need simplification
- Cleaning up technical debt through deletion
- Evaluating feature requests (should we add this or simplify existing code?)
...
- **MAINTENANCE Phase Integration**: Designed for brownfield refactoring
...
1. Load mindset (e.g., "data-over-abstractions.md")
...
- `SKILL.md` - Main skill definition and implementation guide
...
This skill integrates with AICodePath by:

- Targeting **MAINTENANCE phase** work specifically
- Providing a framework for brownfield refactoring decisions
- Complementing technical debt reduction strategies
- Offering philosophical grounding for simplification efforts
- Supporting the "reduce before you add" principle
...
- Adapted for AICodePath by the aicodepath team
- Integration focused on MAINTENANCE phase and brownfield refactoring contexts
