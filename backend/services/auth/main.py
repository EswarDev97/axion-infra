"""
MindFlow Auth Service - Main Application
Per TECH_STACK.md: FastAPI on port 8101

Usage:
    uvicorn services.auth.main:app --host 0.0.0.0 --port 8101 --reload
"""
...
health_check = HealthCheck(service_name="auth-service", version="0.1.0")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="MindFlow Auth Service",
        description="Authentication and Authorization service for MindFlow",
        version="0.1.0",
