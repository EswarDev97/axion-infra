...
- [ ] **Applicable to MAINTENANCE phase?** Helps with brownfield refactoring
...
When adding mindsets for aicodepath:

- Consider how it applies to **MAINTENANCE phase** work
- Think about **brownfield refactoring** scenarios
- Ensure it helps with legacy code simplification
- Frame insights in terms of long-term maintainability
