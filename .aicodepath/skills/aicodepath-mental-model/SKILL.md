---
name: aicodepath-mental-model
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash
argument-hint: "[commit|branch|range|custom]"
description: Build mental models of code changes — logical chunks with dependency ordering for diffs, PRs, and brownfield code.
---
...
This skill is particularly valuable during:

1. **INCEPTION Phase**: Understanding brownfield codebases before planning changes
2. **Code Review**: Building context for reviewing pull requests
3. **Onboarding**: Helping new team members understand recent changes
4. **Documentation**: Capturing the "why" behind significant changes

## NEVER Do

- NEVER just list files without explaining their purpose
- NEVER skip the dependency analysis - order matters
- NEVER ignore the "gotchas" section - non-obvious details are crucial
- NEVER provide a wall of text without structure
- NEVER assume the reader knows the codebase already
